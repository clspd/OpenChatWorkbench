...
export const cookie_consent_updated_at = 1771172142;
export const init_config_ts_value = "202602250424+0800";
export const domain_name_main_root = "openchatworkbench.com";
...
export const trace_info_url = "https://cfsvc.openchatworkbench.com/cdn-cgi/trace";
export const domain_name_root = (window.location.hostname.endsWith(domain_name_main_root) ? domain_name_main_root : window.location.hostname); // for cookies-based data; note that must be correctly set to work in development environment
